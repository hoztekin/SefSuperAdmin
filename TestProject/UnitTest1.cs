namespace TestProject
{
    ...
    {
        // private readonly Mock<IRepository<Product>> _mockrRepo;
        // private readonly ProductController _controller;
        // private List<Product> products;

        //public UnitTest1()
        //{
        //   _mockrRepo = new Mock<IRepository<Product>>();
        //   _controller = new ProductController(_mockRepo.Object);
        //   products = new List<Product>() { new Product {Id = 1, Name="Kitap", Price=50}};
        //}
